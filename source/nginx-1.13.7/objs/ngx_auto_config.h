#define NGX_CONFIGURE " --prefix=/usr/local/nginx/ --with-http_realip_module --with-http_addition_module --with-http_gzip_static_module --with-http_secure_link_module --with-http_stub_status_module --with-stream --with-pcre=/home/ubuntu/nginx_compile/source/pcre-8.41 --with-zlib=/home/ubuntu/nginx_compile/source/zlib-1.2.11 --with-openssl=/home/ubuntu/nginx_compile/source/openssl-1.1.0g --with-debug --with-cc-opt='-g -o0'"
